package org.wickedsource.docxstamper.resolver.registry.typeresolver.image;
 ...
 */
public class ImageResolver extends AbstractTypeResolver<Image, R> {
    ...
    public R resolve(WordprocessingMLPackage document, Image image) {
        try {
            ...
            return createRunWithImage(document, image.getImageBytes(), image.getFilename(), image.getAltText(), image.getMaxWidth());
        } catch (Exception e) {
